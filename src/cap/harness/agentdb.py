...
_AGENT_KEYWORDS: dict[str, list[str]] = {
    ...
    "cicd": ["github actions", "workflow", "release", "artifact", "promote", "gate"],
    "explore": ["find", "search", "locate", "where", "grep", "symbol"],
    # Platform Engineering
    "terraform-modules": ["terraform module", "tflint", "terratest", "variable validation", "tf module"],
    "terraform-state": ["terraform state", "state mv", "backend", "state migration", "remote state"],
    "terraform-import": ["terraform import", "import block", "generated config", "drift"],
    "eks-cluster": ["eks cluster", "cluster upgrade", "oidc", "envelope encryption", "version skew"],
    "eks-node-groups": ["node group", "launch template", "bottlerocket", "imdsv2", "gpu node"],
    "eks-addons": ["eks addon", "vpc-cni", "ebs-csi", "coredns", "pod identity"],
    "argocd-apps": ["argocd app", "applicationset", "app-of-apps", "multi-source"],
    "argocd-sync": ["sync wave", "presync", "postsync", "lua health", "sync policy"],
    "helm-charts": ["helm chart", "_helpers.tpl", "chart dependency", "helm-unittest"],
    "helm-values": ["helm values", "values hierarchy", "sops", "json schema validation"],
    "karpenter": ["karpenter", "nodepool", "ec2nodeclass", "consolidation", "disruption budget"],
    "vpc-network": ["vpc", "transit gateway", "cidr", "vpc endpoint", "flow log", "network"],
    "subnet-design": ["subnet", "tier separation", "prefix delegation", "ipv6", "subnet tag"],
    "route53-dns": ["route53", "dns", "routing policy", "health check", "dnssec", "resolver"],
    "cloudfront-cdn": ["cloudfront", "cdn", "oac", "cache policy", "lambda@edge", "origin"],
    "nlb-loadbalancer": ["nlb", "network load balancer", "tcp", "udp", "grpc", "privatelink"],
    "alb-ingress": ["alb", "ingress", "application load balancer", "target group", "listener"],
    # Development
    "python-backend": ["python", "fastapi", "flask", "django", "pydantic", "sqlalchemy"],
    "typescript-frontend": ["typescript", "react", "next.js", "frontend", "component", "hook"],
    "rest-endpoints": ["rest", "endpoint", "http", "api route", "controller", "handler"],
    "graphql-schema": ["graphql", "schema", "resolver", "mutation", "subscription", "query type"],
    "grpc-services": ["grpc", "protobuf", "proto", "service definition", "streaming rpc"],
    "websocket-handlers": ["websocket", "ws", "socket", "real-time", "pub/sub", "channel"],
    "orm-models": ["orm", "model", "sqlalchemy", "typeorm", "prisma", "migration", "schema"],
    "error-handling": ["error handling", "exception", "retry", "circuit breaker", "fallback"],
    "feature-flags": ["feature flag", "toggle", "launchdarkly", "split", "canary flag"],
    "cli-tools": ["cli", "command line", "argparse", "click", "cobra", "terminal"],
    "api-design": ["api design", "rest design", "openapi", "swagger", "api versioning"],
    "api-contract": ["api contract", "schema validation", "consumer driven", "pact", "backward compatible"],
    "sdk-client": ["sdk", "client library", "api client", "wrapper", "binding"],
    "sdk-developer": ["sdk development", "public api", "plugin system", "extension api"],
    "algorithm": ["algorithm", "data structure", "complexity", "big-o", "sorting", "graph"],
    "database": ["database", "schema design", "nosql", "dynamodb", "single-table", "migration strategy"],
    "database-migrations": ["migration", "alembic", "flyway", "liquibase", "schema change", "down migration"],
    "caching-strategy": ["cache", "redis", "memcached", "invalidation", "ttl", "cache aside"],
    "queue-workers": ["queue", "worker", "consumer", "producer", "dead letter", "backpressure"],
    "batch-processing": ["batch", "bulk", "etl", "job", "scheduler", "cron job"],
    "monorepo-management": ["monorepo", "turborepo", "nx", "workspace", "lerna", "package boundary"],
    # Testing
    "unit-test-python": ["pytest", "unittest", "python test", "conftest", "parametrize", "fixture"],
    "unit-test-typescript": ["jest", "vitest", "ts test", "describe", "it(", "expect("],
    "integration-test": ["integration test", "testcontainers", "docker compose test", "api test"],
    "e2e-test": ["e2e", "end-to-end", "playwright", "cypress", "selenium", "browser test"],
    "load-test": ["load test", "k6", "locust", "jmeter", "stress test", "throughput"],
    "contract-test": ["contract test", "pact", "consumer driven", "provider verification"],
    "chaos-test": ["chaos", "fault injection", "litmus", "chaos monkey", "gameday"],
    "fuzz-test": ["fuzz", "fuzzing", "property based", "hypothesis", "random input"],
    "mutation-test": ["mutation test", "mutant", "pitest", "stryker", "kill ratio"],
    "snapshot-test": ["snapshot", "jest snapshot", "golden file", "approve", "baseline"],
    "visual-regression": ["visual regression", "percy", "chromatic", "screenshot", "pixel diff"],
    "accessibility-test": ["accessibility", "a11y", "wcag", "aria", "screen reader", "axe"],
    "ab-testing": ["a/b test", "experiment", "variant", "control group", "statistical"],
    "mock-service": ["mock", "wiremock", "nock", "msw", "stub", "fake service"],
    "test-data-generation": ["test data", "factory", "faker", "seed", "fixture data"],
    "test-infrastructure": ["test infra", "ci test", "parallel test", "flaky", "test grid"],
    # Security
    "iam-policy-review": ["iam policy", "policy review", "overpermission", "action audit"],
    "container-scanning": ["container scan", "trivy", "grype", "clair", "image vulnerability"],
    "dependency-audit": ["dependency audit", "snyk", "dependabot", "npm audit", "cve scan"],
    "secret-rotation": ["secret rotation", "rotate key", "credential lifecycle", "automatic rotation"],
    "secrets-manager": ["secrets manager", "vault", "hashicorp vault", "ssm parameter", "sealed secret"],
    "network-security": ["network security", "security group", "nacl", "firewall", "zero trust network"],
    "compliance-gdpr": ["gdpr", "data protection", "right to erasure", "consent", "dpa"],
    "compliance-hipaa": ["hipaa", "phi", "health data", "baa", "safeguard"],
    "compliance-sox": ["sox", "sarbanes", "financial control", "audit trail", "segregation of duties"],
    "threat-model": ["threat model", "stride", "attack surface", "data flow diagram", "trust boundary"],
    "penetration-test": ["pentest", "penetration test", "exploit", "attack vector", "red team"],
    "incident-forensics": ["forensic", "evidence", "chain of custody", "memory dump", "artifact"],
    "encryption-review": ["encryption", "kms", "tls", "certificate", "at-rest", "in-transit"],
    "waf-rules": ["waf", "web application firewall", "rate limit", "bot", "owasp rule"],
    "zero-trust": ["zero trust", "beyondcorp", "identity aware", "microsegmentation"],
    "least-privilege-audit": ["least privilege", "permission boundary", "unused permission", "access advisor"],
    # Observability
    "prometheus-metrics": ["prometheus", "promql", "recording rule", "histogram", "cardinality"],
    "grafana-dashboards": ["grafana", "dashboard", "panel", "template variable", "grafana json"],
    "alertmanager-rules": ["alertmanager", "alert rule", "prometheusrule", "pagerduty", "routing tree"],
    "distributed-tracing": ["tracing", "opentelemetry", "otel", "span", "trace id", "w3c propagation"],
    "log-aggregation": ["log aggregation", "fluent bit", "fluentd", "cloudwatch logs", "opensearch"],
    "error-tracking": ["error tracking", "sentry", "fingerprint", "source map", "breadcrumb"],
    "apm-setup": ["apm", "datadog", "new relic", "elastic apm", "transaction naming"],
    "synthetic-monitoring": ["synthetic", "canary", "health check", "uptime", "availability probe"],
    "cost-monitoring": ["cost anomaly", "aws budgets", "kubecost", "cost allocation", "ri utilization"],
    # CI/CD
    "github-actions": ["github action", "reusable workflow", "composite action", "oidc auth", "matrix"],
    "gitlab-ci": ["gitlab ci", "gitlab-ci.yml", "gitlab runner", "needs:", "gitlab pipeline"],
    "jenkins-pipeline": ["jenkins", "jenkinsfile", "shared library", "declarative pipeline"],
    "build-optimization": ["build", "multi-stage", "buildkit", "cache mount", "parallel build"],
    "release-management": ["release", "semantic-release", "commitlint", "hotfix", "changelog"],
    "canary-deploy": ["canary", "flagger", "argo rollout", "traffic weight", "progressive delivery"],
    "blue-green-deploy": ["blue-green", "blue green", "target group switch", "weighted routing"],
    "rollback-strategy": ["rollback", "rollback strategy", "undo", "revert", "feature flag rollback"],
    "artifact-management": ["artifact", "ecr", "cosign", "slsa", "image signing", "oci"],
    "environment-promotion": ["promotion", "dev staging prod", "environment gate", "smoke test"],
    "gitops-patterns": ["gitops", "applicationset", "sealed secret", "image updater", "app-of-apps"],
    # Data
    "data-pipeline": ["data pipeline", "airflow", "dagster", "prefect", "step function"],
    "data-lake": ["data lake", "s3 partitioning", "iceberg", "hudi", "glue catalog"],
    "data-warehouse": ["data warehouse", "redshift", "bigquery", "snowflake", "dimensional model"],
    "etl-transform": ["etl", "transform", "dbt", "spark", "data quality check"],
    "streaming-kafka": ["kafka", "streaming", "avro", "consumer group", "partition"],
    "schema-registry": ["schema registry", "avro schema", "compatibility", "evolution"],
    "analytics-dashboard": ["analytics", "dashboard", "quicksight", "looker", "bi tool"],
    "data-governance": ["data governance", "lineage", "catalog", "classification", "retention policy"],
    "data-quality": ["data quality", "great expectations", "deequ", "validation rule"],
    # Documentation
    "adr-writer": ["adr", "architecture decision", "decision record", "context and decision"],
    "runbook-author": ["runbook", "playbook", "operational procedure", "escalation path"],
    "api-docs": ["api documentation", "openapi spec", "swagger doc", "redoc"],
    "onboarding-guide": ["onboarding", "getting started", "new developer", "setup guide"],
    "changelog-generator": ["changelog", "release notes", "what's new", "breaking change list"],
    # AWS Services
    "lambda-functions": ["lambda function", "serverless", "cold start", "layer", "invocation"],
    "step-functions": ["step function", "state machine", "choice state", "parallel state", "workflow"],
    "dynamodb": ["dynamodb", "partition key", "gsi", "lsi", "single-table design", "on-demand"],
    "rds-aurora": ["rds", "aurora", "postgres", "mysql", "read replica", "proxy"],
    "s3-buckets": ["s3 bucket", "bucket policy", "lifecycle rule", "replication", "object lock"],
    "sqs-queues": ["sqs", "queue", "fifo", "visibility timeout", "dlq", "message"],
    "sns-topics": ["sns", "topic", "notification", "fanout", "subscription filter"],
    "eventbridge": ["eventbridge", "event bus", "rule", "event pattern", "scheduler"],
    "ecr-registry": ["ecr", "container registry", "lifecycle policy", "image scanning"],
    "ecs-fargate": ["ecs", "fargate", "task definition", "service", "capacity provider"],
    "parameter-store": ["parameter store", "ssm", "stringlist", "secureparam", "hierarchy"],
    # Misc
    "incident-response": ["incident", "p1", "p2", "mitigation", "post-mortem", "triage"],
    "capacity-planning": ["capacity", "scaling threshold", "headroom", "forecast", "right-size"],
    "dependency-updates": ["dependency update", "renovate", "dependabot", "bump", "upgrade package"],
    "logging-structured": ["structured log", "json logging", "correlation id", "log level", "context"],
    "react-components": ["react component", "jsx", "tsx", "hook", "state management", "props"],
    "system-design": ["system design", "distributed", "scalability", "consistency", "cap theorem"],
    "scrum-master": ["sprint", "scrum", "standup", "retrospective", "velocity", "acceptance criteria"],
    "orchestrator": ["orchestrate", "coordinate", "multi-agent", "delegation", "workflow"],
}
